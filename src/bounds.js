import {area, areaRingSum} from "./area";
import {cartesian, cartesianCross, cartesianNormalizeInPlace} from "./cartesian";
import {abs, degrees, radians} from "./math";
...
export default (function() {
  ...
  var bound = {
    ...
    polygonEnd: function() {
      ...
      else if (dLambdaSum > 1e-6) phi1 = 90;
      else if (dLambdaSum < -1e-6) phi0 = -90;
  ...
  function ringEnd() {
    ...
    area.lineEnd();
    if (abs(dLambdaSum) > 1e-6) lambda0 = -(lambda1 = 180);
    range[0] = lambda0, range[1] = lambda1;
    p0 = null;
  }
